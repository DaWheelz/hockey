...
class Profile extends Component {
    ...
    getTeams() {
        fetch(`http://hockey.mutsaers.nu:5000/clubs/team/`).then(response => {
    ...
    getUsers() {
        ...
        const API_URL = "http://hockey.mutsaers.nu:5000/s";
        ...
        fetch(API_URL, {
            ...
            .then(result => {
                if (result.user) {
                    ...
                    axios.get(`http://hockey.mutsaers.nu:5000/users/${result.user._id}`).then(response => {
                        this.setState({
    ...
    onSubmit(e) {
        ...
        fetch(`http://hockey.mutsaers.nu:5000/users/updateprofile/${this.state.id}`, {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
